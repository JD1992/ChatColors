...
public class MessageHandler {
	...
	public MessageHandler ( JavaPlugin plugin ) {
		...
		this.consolePrefix = ChatColor.translateAlternateColorCodes( '&', this.plugin.getConfig().getString( Constants.Texts.Prefix.CONSOLE ) ) + " ";
		this.ingamePrefix = ChatColor.translateAlternateColorCodes( '&', this.plugin.getConfig().getString( Constants.Texts.Prefix.USER ) ) + " ";
	}
